...
def eval_model(args):
    ...
    elif args.dataset =="multi_modal_paper":
        data_dir = meta_data_path + "multi_modal_paper/"
    elif args.dataset == "Amazon_Rec_Baby":
        data_dir = meta_data_path + "Amazon_Rec_Baby/"
    elif args.dataset == "Amazon_Rec_Sports":
        data_dir = meta_data_path + "Amazon_Rec_Sports/"
    elif args.dataset == "Amazon_Rec_Clothing":
    ...
    pretrained_embs = torch.load(graph_embedding_path)[:4]
    prompt_file=os.path.join(data_dir,f"test_edge_data.jsonl")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", type=str, default="/data/taofeng2/GWM/embedding_based/embedding_llm/train/checkpoints_debug_/llaga-llama-3-checkpoint-183")
    ...
    parser.add_argument("--dataset", type=str, default="multi_modal_paper")
